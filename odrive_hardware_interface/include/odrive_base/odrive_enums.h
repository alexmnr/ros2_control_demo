...
// Parameter Ids from flat_endpoints.json for version 0.6.11-1 (THESE MIGHT CHANGE WITH FUTURE VERSIONS)
enum ODriveParameterEndpoints {
  CONTROLLER_VEL_LIMIT = 374,
  CONTROLLER_ENABLE_VEL_LIMIT = 363,
  INPUT_FILTER_BANDWITH = 387,
};
